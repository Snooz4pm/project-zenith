...
export function DisciplineBadge() {
    ...
    const { openPanel, isOpen: isPanelOpen } = useDisciplineGatePanel();
            ...
            <AnimatePresence>
                {showTooltip && !isPanelOpen && (
                    <motion.div
                        ...
                        className="absolute top-full right-0 mt-2 w-64 p-3 bg-[#0a0a12] border border-white/10 rounded-lg shadow-2xl z-[100]"
                    >
