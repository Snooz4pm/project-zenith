...
// Zenith Theme Colors
const vec3 MINT  = vec3(20.0, 241.0, 149.0) / 255.0;
...
vec3 background_color(vec2 uv) {
  ...
  float m = uv.y - y;
  col += mix(CYAN, BLACK, smoothstep(0.0, 1.0, abs(m)));
  col += mix(MINT, BLACK, smoothstep(0.0, 1.0, abs(m - 0.8)));
  return col * 0.5;
}
...
export default function FloatingLines({
    linesGradient = ['#14F195', '#00D4FF'], // Zenith mint to cyan
    enabledWaves = ['top', 'middle', 'bottom'],
    lineCount = [10, 15, 20],
    lineDistance = [8, 6, 4],
    topWavePosition,
