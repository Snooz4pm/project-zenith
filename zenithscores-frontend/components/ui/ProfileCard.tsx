...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
    ...
    const getOffsets = (evt: MouseEvent | PointerEvent | React.MouseEvent | React.PointerEvent, el: HTMLElement) => {
    ...
    useEffect(() => {
        ...
        // We need to cast the handlers because React events overlap with DOM events but types are slightly different
        // Using `any` here for simplicity with DOM event listeners in useEffect
