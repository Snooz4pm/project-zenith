...
export default function FlowPage() {
    ...
    return (
        <div className="min-h-screen bg-[#050709] text-white">
            {/* Header */}
            <header className="fixed top-0 left-0 right-0 z-40 bg-[#050709]/80 backdrop-blur-md border-b border-zinc-800/50">
            ...
            {/* Main Content */}
            <main className="pt-28 px-4 sm:px-6 lg:px-8 pb-12 max-w-[1800px] mx-auto">
                {/* Section A: Hot Now */}
