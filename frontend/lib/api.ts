...
class NewsAPI {
    ...
    async getArticlesByCategory(
        ...
        const endpoint = `/articles/${category}${query ? `?${query}` : ''}`;
    ...
    async getArticleById(id: number): Promise<Article> {
        return this.fetchAPI<Article>(`/articles/id/${id}`);
    }
    ...
    async getTopArticles(options?: {
        ...
        const query = params.toString();
        return this.fetchAPI(`/top-articles${query ? `?${query}` : ''}`);
    }
    ...
    async getCategories(): Promise<CategoriesResponse> {
        return this.fetchAPI<CategoriesResponse>('/categories');
    }
    ...
    async getStats(): Promise<StatsResponse> {
        return this.fetchAPI<StatsResponse>('/stats');
    }
